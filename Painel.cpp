...
constexpr unsigned char Quantidade_Botoes           = 12 ;
...
constexpr unsigned char Botao_Aumentar_Intensidade_Esquerda  = 4 ;
constexpr unsigned char Botao_Diminuir_Intensidade_Esquerda  = 5 ;
constexpr unsigned char Botao_Aumentar_Intensidade_Subir     = 6 ;
constexpr unsigned char Botao_Diminuir_Intensidade_Subir     = 7 ;
constexpr unsigned char Botao_Aumentar_Vento                 = 8 ;
constexpr unsigned char Botao_Diminuir_Vento                 = 9 ;
constexpr unsigned char Botao_Aumentar_Altura_Fogo           = 10;
constexpr unsigned char Botao_Diminuir_Altura_Fogo           = 11;
...
void _Definir_Botoes(BOTAO Mapa[], short int Largura){
    ...
    Mapa[Botao_Apagar_Fogo].            _Criar_BOTAO("Apagar fogo"          , Largura - 30, 150, 30, 30,'D');
